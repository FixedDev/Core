package us.sparknetwork.core.vault;
...
public class EconomyVaultConnector extends AbstractEconomy {
    private static final Logger log = Logger.getLogger("Minecraft");

    private final String name = "Core Eco";
    private Plugin plugin;
    private CorePlugin cp = null;

    public EconomyVaultConnector(Plugin plugin) {
        this.plugin = plugin;
        Bukkit.getServer().getPluginManager().registerEvents(new EconomyServerListener(this), plugin);

        // Load Plugin in case it was loaded before
        if (cp == null) {
            cp = CorePlugin.getPlugin();
        }
    }
    ...
    public EconomyResponse createBank(String name, String player) {
        return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED, "Core Eco does not support bank accounts!");
    }
    ...
    public class EconomyServerListener implements Listener {
        EconomyVaultConnector economy = null;

        public EconomyServerListener(EconomyVaultConnector economy) {
